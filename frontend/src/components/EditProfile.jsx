...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
        if (!input.gender) {
            toast.error('Please select your gender before submitting.');
    ...
    const isSubmitDisabled = !input.gender;
    ...
    return (
        <div className='flex max-w-2xl mx-auto pl-10'>
            <section className='flex flex-col gap-6 w-full my-8'>
                ...
                <div>
                    <h1 className='font-bold mb-2'>Gender <span className='text-red-500'>*</span></h1>
                ...
                <div className='flex justify-end'>
                    {
                        loading ? (
                            ...
                            <Button onClick={editProfileHandler} className='w-fit bg-[#0095F6] hover:bg-[#2a8ccd]' disabled={isSubmitDisabled}>Submit</Button>
                        )
                    }
                </div>
            </section>
